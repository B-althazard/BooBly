const CACHE='boobly-v1.2.2';
const ASSETS=['./','./index.html','./styles.css','./app.js','./database.json','./prompts.json','./manifest.json','./icons/icon-192.png','./icons/icon-512.png','./icons/favicon.png','./icons/preset.png'];
